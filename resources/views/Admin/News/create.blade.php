...
@section('content')
                     ...
                     <div class="col-md-8">
                         ...
                         <div class="card">
                             <div class="card-body row">
                                 ...
                                 <div class="form-group col-sm-12" element="div" bp-field-wrapper="true"
                                      bp-field-name="short_description" bp-field-type="textarea">
                                     <label>Table of Content (Html code) <i class="las la-question" onclick="get_preset()" style="font-size:19px;"></i></label>
                                     <textarea name="tab_content" id="tab_content"  class="form-control" required>
    ...
    <script>
        function get_preset(){
           axios.get('/api/get-presets')
           .then((response)=>{
            CKEDITOR.instances['tab_content'].setData(response.data.presets);
           })
           .catch((error)=>{
                console.log(error);
           })
