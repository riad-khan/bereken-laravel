                                    ...
                                    <div class="card-body row">
                                        ...
                                        @endphp
                                            ...
                                            <div class="form-check">
                                                <input onchange="changeStatus(1)" {{$status[0]->status == 1 ? "checked":""}} class="status form-check-input" name="category_id" type="checkbox" onchange="populerCalculator(this.value)" value="6" id="calculators">
