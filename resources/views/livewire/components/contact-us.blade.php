            ...
            <div class="flex p-6 flex-col items-center ">
                <div class="content text-center sm:text-left flex-none sm:flex sm:justify-center sm:items-center">
                    ...
                    <div class="text-content text-center sm:w-3/5 sm:text-left">
                        ...
                        <h6 class="text-lg font-normal mb-8 text-[#2B313B]">{{$details[0]->contact_section_content}}</h6>
                        <a href="/contact-us"  class="flex w-fit m-auto md:m-0 bg-[#1E3062] opacity-100 hover:opacity-90 transition text-white text-base font-bold py-2.5 px-14 rounded-lg transition-all">{{ $details[0]->button_text }}</a>
                    </div>
                </div>
            </div>
        </div><!-- container end -->
