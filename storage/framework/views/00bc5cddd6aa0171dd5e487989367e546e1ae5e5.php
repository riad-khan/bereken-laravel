...
<?php $__env->startSection('content'); ?>
    <main class="main pt-2">
        ...
        <div class="container-fluid animated fadeIn">
            <div class="row">
                <form action="<?php echo e(url('/admin/vat/' . $details[0]->id)); ?>" method="post">
                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="card-body row">
                                        ...
                                        <div class="form-group col-sm-12" element="div" bp-field-wrapper="true"
                                            ...
                                            <input type="text" name="amount_label"
                                                value="<?php echo e($details[0]->amount_label); ?>" class="form-control" required>
                                        ...
                                        <div class="form-group col-sm-12" element="div" bp-field-wrapper="true"
                                            ...
                                            <textarea name="amount_tooltip" id="amount_tooltip"><?php echo e($details[0]->amount_tooltip); ?></textarea>
                                        ...
                                        <div class="form-group col-sm-12" element="div" bp-field-wrapper="true"
                                            ...
                                            <input type="text" name="convert_label"
                                                value="<?php echo e($details[0]->convert_label); ?>" class="form-control" required>
                                        ...
                                        <div class="form-group col-sm-12" element="div" bp-field-wrapper="true"
                                            ...
                                            <textarea name="convert_tooltip" id="convert_tooltip"><?php echo e($details[0]->convert_tooltip); ?></textarea>
                                        ...
                                        <div class="form-group col-sm-12" element="div" bp-field-wrapper="true"
                                            ...
                                            <input type="text" name="rate_label" value="<?php echo e($details[0]->rate_label); ?>"
                                        ...
                                        <div class="form-group col-sm-12" element="div" bp-field-wrapper="true"
                                            ...
                                            <textarea name="rate_tooltip" id="rate_tooltip"><?php echo e($details[0]->rate_tooltip); ?></textarea>
                                        ...
                                        <div class="form-group col-sm-12" element="div" bp-field-wrapper="true"
                                            ...
                                            <textarea name="content" id="description"><?php echo e($details[0]->content); ?></textarea>
                                        ...
                                        <div class="form-group col-sm-12" element="div" bp-field-wrapper="true"
                                            ...
                                            <textarea name="result_details" id="result_content"><?php echo e($details[0]->result_content); ?></textarea>
                                        ...
                                        <div class="form-group col-sm-12" element="div" bp-field-wrapper="true"
                                            ...
                                            <textarea name="seo_meta" class="form-control"><?php echo e($details[0]->seo_meta); ?></textarea>
                                        ...
                                        <div class="form-group col-sm-12" element="div" bp-field-wrapper="true"
                                            ...
                                            <textarea name="seo_keywords" class="form-control"><?php echo e($details[0]->seo_meta); ?></textarea>
...
<?php echo $__env->make(backpack_view('blank'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dh_ag462h/bereken.webonedevs.com/resources/views/Admin/calculator/vat/edit.blade.php ENDPATH**/ ?>