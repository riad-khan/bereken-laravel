...
<?php $__env->startSection('meta'); ?>
    ...
    <title><?php echo e($seo_data[0]->title); ?> -choose package</title>
                    ...
                    <div class="filter-area" x-data="{ open: false }">
                       <span class="flex border border-[#F5F8FF] rounded-md p-3 mb-4 md:border-none md:p-0 items-center justify-between">     
                        <h2 class="text-[#2B313B] font-semibold text-base">Filters</h2>
                            <button class="visible md:hidden" @click="open = ! open"><img src="<?php echo e(asset('/frontend/assets/img/filter.svg')); ?>" alt="icon"></button>                        
                       </span>
                        ...
                        <div class="in-list grid grid-cols-1 gap-2 lg:flex lg:flex-row lg:justify-between">
                            <div class="grid grid-cols-2 gap-2 lg:flex lg:flex-row lg:justify-between">
                                ...
                                <div class="flex justify-between my-3 md:my-0">
                                    <a href=${item.signup_url} target="_blank" class="flex items-center text-[#0052FE] font-bold text-sm mx-3"> View <img src="<?php echo e(asset('/frontend/assets/img/goto-link.svg')); ?>" class="mx-2" alt="icon"></a>
...
<?php /**PATH /home/dh_ag462h/bereken.webonedevs.com/resources/views/livewire/sim-only/choose-package.blade.php ENDPATH**/ ?>