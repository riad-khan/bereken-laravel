            ...
            <div class="section-title text-center ">
                <h1 class="text-[24px] font-semibold mb-4 p-5 text-[#2B313B] sm:pb-6  sm:pt-4">If your question remains unanswered within our frequently asked questions, please feel free to contact us via the contact form.</h1>
                        ...
                        <div class="main-inner w-full flex p-5">
                            <form class="w-full" id="contact_form" data-parsley-validate="" method="post" action="<?php echo e(url('/send-contact-email')); ?>">
                                <?php echo csrf_field(); ?>
                                <!-- form start -->
...
<?php /**PATH /home/dh_ag462h/bereken.webonedevs.com/resources/views/livewire/contact/contact-us.blade.php ENDPATH**/ ?>