<div>
    <div class="articles mb-3 border-l border-t rounded-t-2xl border-r border-[#F5F8FF]">
      ...
      <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <a href="/news/<?php echo e($row->slug); ?>-<?php echo e($row->id); ?>"
            ...
            <img class="object-cover w-full h-full mb-0" src="<?php echo e(env('STRAPI_URL') . $row->banner_image); ?>" alt="icon" />
</span>
...
<?php /**PATH C:\Users\saleh\OneDrive\Desktop\Hassn Vai\Breken.nl\New-Design\bereken-laravel\resources\views/livewire/components/vats/related-news.blade.php ENDPATH**/ ?>