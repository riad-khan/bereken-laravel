        ...
        <div class="md:flex md:flex md:flex-row md:justify-between flex-none">
            <div class="mb-6 text-center md:text-left md:mb-0 md:basis-1/3 basis-full">
                <a href="#" class="flex justify-center md:justify-start items-center">
                    <img src="<?php echo e(asset('frontend/assets/img/full-logo.svg')); ?>" class="mr-3 h-9" alt="FlowBite Logo" />
                </a>
...
<?php /**PATH C:\Users\riadk\Documents\mftp_zip_2023_06_04_22_19_54\resources\views/livewire/includes/footer.blade.php ENDPATH**/ ?>