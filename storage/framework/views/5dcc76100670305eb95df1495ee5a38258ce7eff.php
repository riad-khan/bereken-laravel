...
} elseif ($_instance->childHasBeenRendered('l3746073609-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3746073609-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3746073609-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3746073609-0');
} else {
    $response = \Livewire\Livewire::mount('components.service', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3746073609-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l3746073609-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l3746073609-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3746073609-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3746073609-1');
} else {
    $response = \Livewire\Livewire::mount('components.populer-calculator', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3746073609-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l3746073609-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l3746073609-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3746073609-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3746073609-2');
} else {
    $response = \Livewire\Livewire::mount('components.review-strategy', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3746073609-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php
...
} elseif ($_instance->childHasBeenRendered('l3746073609-3')) {
    $componentId = $_instance->getRenderedChildComponentId('l3746073609-3');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3746073609-3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3746073609-3');
} else {
    $response = \Livewire\Livewire::mount('components.lattest-news', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3746073609-3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php
...
} elseif ($_instance->childHasBeenRendered('l3746073609-4')) {
    $componentId = $_instance->getRenderedChildComponentId('l3746073609-4');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3746073609-4');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3746073609-4');
} else {
    $response = \Livewire\Livewire::mount('components.contact-us', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3746073609-4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/dh_ag462h/bereken.webonedevs.com/resources/views/livewire/home.blade.php ENDPATH**/ ?>