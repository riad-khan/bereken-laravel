...
<section class="bg-white w-full p-4 md:p-12">
    <div class="container mx-auto max-w-screen-xl">
        ...
        <div class="section-title text-center ">
            <h2 class="text-[32px] font-semibold text-[#2B313B] p-4 sm:pb-16  sm:pt-4"><?php echo e($calculators[0]->section_title); ?></h2>
        </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\riadk\Documents\bereken-laravel\resources\views/livewire/components/populer-calculator.blade.php ENDPATH**/ ?>