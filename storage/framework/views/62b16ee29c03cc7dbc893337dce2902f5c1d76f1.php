<?php
    ...
    $seo_data_sql = 'select
                    ...
                    b.meta_viewport,
                    b.canonical_url
                    from categories_components a
                    left join components_shared_seos b on b.id = a.component_id
                    where a.entity_id = ?';
    
    $seo_data = DB::select($seo_data_sql, [$id]);
    $socialSql = 'select a.social_network,a.title,a.description,d.url  from components_shared_meta_socials a
    left join components_shared_seos_components b on b.component_id = a.id
    left join files_related_morphs c on (c.related_id = b.component_id and c.field="image")
