...
} elseif ($_instance->childHasBeenRendered('l3148704369-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3148704369-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3148704369-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3148704369-0');
} else {
    $response = \Livewire\Livewire::mount('components.news.highlights', ['category' => 'all']);
    $html = $response->html();
    $_instance->logRenderedChild('l3148704369-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l3148704369-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l3148704369-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3148704369-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3148704369-1');
} else {
    $response = \Livewire\Livewire::mount('components.news.other-news', ['category' => 'all']);
    $html = $response->html();
    $_instance->logRenderedChild('l3148704369-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
} elseif ($_instance->childHasBeenRendered('l3148704369-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l3148704369-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3148704369-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3148704369-2');
} else {
    $response = \Livewire\Livewire::mount('components.news.hot-article', ['category' => 'all']);
    $html = $response->html();
    $_instance->logRenderedChild('l3148704369-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/dh_ag462h/bereken.webonedevs.com/resources/views/livewire/news/news.blade.php ENDPATH**/ ?>