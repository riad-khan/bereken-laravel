            ...
            <div class="center">
                ...
                <div class="items">
                    <a href="/news/<?php echo e($row->slug); ?>-<?php echo e($row->id); ?>" class="flex  mb-3 p-2 flex-col transition-all hover:bg-[#EBF1FF] border border-[#EBF1FF] hover:border-[#EBF1FF] rounded-lg hover:shadow md:flex-col  bg-white">
                        <img class="object-cover rounded-t-lg h-52 h-40 md:rounded-md" src="<?php echo e(url($row->thumbnill_image)); ?>" alt="image">
...
<?php /**PATH /home/dh_ag462h/bereken.webonedevs.com/resources/views/livewire/components/news-slider/news-slider.blade.php ENDPATH**/ ?>