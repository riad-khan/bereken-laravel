        ...
        <div class="container mx-auto max-w-screen-xl flex-none md:flex md:flex-row">
                    ...
                    <form id="vat_form" method="post" data-parsley-validate="" action="<?php echo e(url('/calculate-vat')); ?>" enctype="multipart/form-data">
                        ...
                        <div class="grid gap-4 mb-4 md:mb-6 md:grid-cols-2">
                            <div class="order-1"> <span class="flex justify-between">
                                    <label for="amount"
                                        class="block mb-2  text-xs font-normal text-[#2B313B]"><?php echo e($details[0]->amount_label); ?></label>
                            ...
                            <div  class="order-3 md:order-2">
                                <span class="flex justify-between">
                                    <label for="weight" class="block mb-2  text-xs font-normal text-[#2B313B]"><?php echo e($details[0]->convert_label); ?></label>
                            ...
                            <div class="t-select order-2 md:order-3">
                                <span class="flex justify-between">
                                    <label for="rate" class="block mb-2 text-xs font-normal text-[#2B313B]"><?php echo e($details[0]->rate_label); ?></label>
                                    <!--Code Block for white tooltip starts-->
                            ...
                            <div class="block md:flex md:items-end order-4">
                                <button type="submit"
                                    class="outline-btn btn-translate-z flex bg-[#0052FE] opacity-100 hover:opacity-90 transition justify-center text-white font-bold rounded-md text-xs w-full px-5 py-3.5 text-center"><?php echo e($details[0]->button_text); ?></button>
                            ...
                            <div class="tag-area flex-wrap flex md:flex-none">
                                ...
                                <?php
                                    ...
                                    <a target="_blank" href="<?php echo e($item->link); ?>"
                                        class="text-[#0052FE] bg-white border border-[#0052FE] font-normal rounded-md transition-all text-[10px] px-2.5 py-1 text-center mr-2 mb-2"><?php echo e($item->name); ?></a>
            ...
            <div class="side-bar basis-full md:basis-4/12">
                <div class="inner-area ml-1 lg:ml-4 p-2 md:p-0">
                    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('components.vats.featured-calculators', [])->html();
} elseif ($_instance->childHasBeenRendered('l4180263488-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l4180263488-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4180263488-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4180263488-0');
} else {
    $response = \Livewire\Livewire::mount('components.vats.featured-calculators', []);
    $html = $response->html();
    $_instance->logRenderedChild('l4180263488-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>     
                    <?php
...
} elseif ($_instance->childHasBeenRendered('l4180263488-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l4180263488-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4180263488-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4180263488-1');
} else {
    $response = \Livewire\Livewire::mount('components.vats.related-news', []);
    $html = $response->html();
    $_instance->logRenderedChild('l4180263488-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>   
                    ...
                    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('components.vats.faq-section', [])->html();
} elseif ($_instance->childHasBeenRendered('l4180263488-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l4180263488-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4180263488-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4180263488-2');
} else {
    $response = \Livewire\Livewire::mount('components.vats.faq-section', []);
    $html = $response->html();
    $_instance->logRenderedChild('l4180263488-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    ...
                    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('components.vats.vat-ratings', [])->html();
} elseif ($_instance->childHasBeenRendered('l4180263488-3')) {
    $componentId = $_instance->getRenderedChildComponentId('l4180263488-3');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4180263488-3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4180263488-3');
} else {
    $response = \Livewire\Livewire::mount('components.vats.vat-ratings', []);
    $html = $response->html();
    $_instance->logRenderedChild('l4180263488-3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php /**PATH /home/dh_ag462h/bereken.webonedevs.com/resources/views/livewire/calculators/v-a-t/vats.blade.php ENDPATH**/ ?>