                    ...
                    <li class="ellipsis-p">
                        <a href="/news/<?php echo e($item->slug); ?>-<?php echo e($item->id); ?>"
                            ...
                            <img class="object-cover w-full rounded-lg h-96 md:h-[172px] md:w-[172px]"
                                src=<?php echo e(env("STRAPI_URL").$item->thumbnill_image); ?>>
...
<?php /**PATH C:\Users\saleh\OneDrive\Desktop\Hassn Vai\Breken.nl\New-Design\bereken-laravel\resources\views/livewire/components/news/other-news.blade.php ENDPATH**/ ?>