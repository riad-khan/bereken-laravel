        ...
        <div class="container mx-auto max-w-screen-xl">
            ...
            <div class="btn-area flex justify-center">
                <a href="/news"
                    ...
                    <span class="flex items-center"> View
                    More <img src="<?php echo e(asset('frontend/assets/img/icons/arrow-white.svg')); ?>" class="ml-2 h-2 w-2 float-right" class="ml-2"
                        alt="icon"></span></a>
            </div>
        </div> <!-- container end -->
             <!-- Main modal -->
...
<?php /**PATH C:\Users\riadk\Documents\mftp_zip_2023_06_04_22_19_54\resources\views/livewire/components/lattest-news.blade.php ENDPATH**/ ?>