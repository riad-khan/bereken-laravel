...
} elseif ($_instance->childHasBeenRendered('l4141150102-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l4141150102-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4141150102-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4141150102-0');
} else {
    $response = \Livewire\Livewire::mount('components.b-m-i.bmi-details', ['details' => $details[0]->content]);
    $html = $response->html();
    $_instance->logRenderedChild('l4141150102-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        ...
                        <div class="bottom-part flex-none lg:flex lg:justify-between">
                            <div class="w-full lg:w-auto more-links">
                                ...
                                <div class="flex-wrap flex md:flex-none">
                                    <?php
                                        $list = DB::table('others_calculators')->where('calculator_id','=','1')->get();
                                    ?>
            ...
            <div class="side-bar basis-full md:basis-4/12">
                <div class="inner-area ml-1 lg:ml-4 p-2 md:p-0">
                    ...
                    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('components.b-m-i.featured-calculators', [])->html();
} elseif ($_instance->childHasBeenRendered('l4141150102-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l4141150102-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4141150102-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4141150102-1');
} else {
    $response = \Livewire\Livewire::mount('components.b-m-i.featured-calculators', []);
    $html = $response->html();
    $_instance->logRenderedChild('l4141150102-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php
...
} elseif ($_instance->childHasBeenRendered('l4141150102-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l4141150102-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4141150102-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4141150102-2');
} else {
    $response = \Livewire\Livewire::mount('components.b-m-i.related-articles', []);
    $html = $response->html();
    $_instance->logRenderedChild('l4141150102-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('components.b-m-i.bmi-faq', [])->html();
} elseif ($_instance->childHasBeenRendered('l4141150102-3')) {
    $componentId = $_instance->getRenderedChildComponentId('l4141150102-3');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4141150102-3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4141150102-3');
} else {
    $response = \Livewire\Livewire::mount('components.b-m-i.bmi-faq', []);
    $html = $response->html();
    $_instance->logRenderedChild('l4141150102-3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php
...
} elseif ($_instance->childHasBeenRendered('l4141150102-4')) {
    $componentId = $_instance->getRenderedChildComponentId('l4141150102-4');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4141150102-4');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4141150102-4');
} else {
    $response = \Livewire\Livewire::mount('components.b-m-i.bmi-ratings', []);
    $html = $response->html();
    $_instance->logRenderedChild('l4141150102-4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/dh_ag462h/bereken.webonedevs.com/resources/views/livewire/calculators/b-m-i/bmi-calculator.blade.php ENDPATH**/ ?>