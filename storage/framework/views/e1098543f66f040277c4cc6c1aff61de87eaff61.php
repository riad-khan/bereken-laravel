        ...
        <div class="container mx-auto max-w-screen-xl flex-none md:flex md:flex-row">
            ...
            <div class="main-area basis-full p-2 md:p-3 lg:p-0 md:basis-8/12">
                ...
                <span class="flex flex-col sm:flex-row justify-between mb-5 items-center">
                    <h3 class="mb-2 md:mb-0 text-2xl basis-full text-[#2B313B] sm:basis-1/2 font-semibold">Highlights</h3>
...
} elseif ($_instance->childHasBeenRendered('l3591557562-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3591557562-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3591557562-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3591557562-0');
} else {
    $response = \Livewire\Livewire::mount('components.news.highlights', ['category' => 'all']);
    $html = $response->html();
    $_instance->logRenderedChild('l3591557562-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l3591557562-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l3591557562-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3591557562-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3591557562-1');
} else {
    $response = \Livewire\Livewire::mount('components.news.other-news', ['category' => 'all']);
    $html = $response->html();
    $_instance->logRenderedChild('l3591557562-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
                ...
                <div class="inner-area ml-1 lg:ml-4 p-2 md:p-0">
                    ...
                    <div class="adds-area p-4 flex flex-col bg-[#F5F8FF] rounded-lg mb-3">
                        ...
                        <p class="text-[#6C7A93] font-normal mb-2 text-sm">Save an average of € 259 per year on your car
                            insurance?</p>
                        <a href="/compares"
                            class="px-4 py-3 text-center bg-[#1E3062] opacity-100 hover:opacity-90 transition text-white text-base font-bold rounded-md">Get
                            it Now</a>
                    </div>
...
} elseif ($_instance->childHasBeenRendered('l3591557562-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l3591557562-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3591557562-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3591557562-2');
} else {
    $response = \Livewire\Livewire::mount('components.news.hot-article', ['category' => 'all']);
    $html = $response->html();
    $_instance->logRenderedChild('l3591557562-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\Users\saleh\OneDrive\Desktop\Hassn Vai\Breken.nl\New-Design\bereken-laravel\resources\views/livewire/news/news.blade.php ENDPATH**/ ?>