                ...
                <div class="main-inner p-5 border border-[#F5F8FF] rounded-t-2xl">
                    ...
                    <div id="load-more" class="transition-all">
                            <div class="single-info py-4">
                                    ...
                                    <?php
                                        $result_content = DB::table('bmis')->select('result_content')->get();
                                    ?>
...
} elseif ($_instance->childHasBeenRendered('l2273366259-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2273366259-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2273366259-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2273366259-0');
} else {
    $response = \Livewire\Livewire::mount('components.b-m-i.featured-calculators', []);
    $html = $response->html();
    $_instance->logRenderedChild('l2273366259-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l2273366259-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l2273366259-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2273366259-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2273366259-1');
} else {
    $response = \Livewire\Livewire::mount('components.b-m-i.related-articles', []);
    $html = $response->html();
    $_instance->logRenderedChild('l2273366259-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l2273366259-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l2273366259-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2273366259-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2273366259-2');
} else {
    $response = \Livewire\Livewire::mount('components.b-m-i.bmi-faq', []);
    $html = $response->html();
    $_instance->logRenderedChild('l2273366259-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php
...
} elseif ($_instance->childHasBeenRendered('l2273366259-3')) {
    $componentId = $_instance->getRenderedChildComponentId('l2273366259-3');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2273366259-3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2273366259-3');
} else {
    $response = \Livewire\Livewire::mount('components.b-m-i.bmi-ratings', []);
    $html = $response->html();
    $_instance->logRenderedChild('l2273366259-3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php /**PATH /home/dh_ag462h/bereken.webonedevs.com/resources/views/livewire/calculators/b-m-i/bmi-result.blade.php ENDPATH**/ ?>