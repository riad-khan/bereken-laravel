<?php
    $seo_data = DB::table('seo_data_tables')->where('page','=','Borrow money')->get();
?>
...
<div>
            ...
            <div class="services-area w-full py-8">
                ...
                <div class="flex-none md:flex md:items-center md:justify-around">
                    <div class="w-full md:w-80 flex flex-col">
                        <h1 class="flex items-center text-base font-normal text-[#26BA65] mb-5"><img src="<?php echo e(asset('/frontend/assets/img/verified.svg')); ?>" class="w-6 h-6 mr-2" alt="icon"> Understandable explanation</h1>
                        ...
                        <button type="button"  @click="open = ! open" class="outline-btn btn-translate-z flex md:hidden items-center w-fit bg-[#F9FBFF] text-white text-base font-bold py-2.5 px-6 mb-3">Get Started <img class="ml-4  " src="<?php echo e(asset('frontend/assets/img/arrow-white.svg')); ?>" alt="arrow-icon"></button>
                        ...
                        <div :class="{'block': open, 'hidden': !open}" class="hidden p-5 rounded-2xl border border-[#F5F8FF] bg-white">
                            <form action="" class="flex flex-col">
                                ...
                                <div class="mb-3">
                                    <label for="" class="block mb-2 text-sm font-normal text-[#2B313B]">Loan Purpose
                                    </label>
                                    
                                    <div class="t-select no-label">
                                            <select id="gender" class="bg-white border border-[#F5F8FF] text-[#2B313B] font-semibold text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                                                <option class="p-3 bg-white border-b border border-[#cccccc] text-sm rounded-lg font-base" value="Petrol" selected="">Purchase Car</option>
                                ...
                                <div class="mb-3">
                                    <label for="" class="block mb-2 text-sm font-normal text-[#2B313B]">Loan Amount </label>                                    
                                        <div class="flex">
                                            <input type="text" 
                                            class="green-tick rounded-lg bg-white border border-[#F5F8FF] text-[#2B313B] font-normal text-sm focus:ring-none focus:outline-none focus:border-[#3b82f6] block flex-1 min-w-0 w-full p-2.5"
                                            placeholder="">
                                        </div>
                                </div>
                                <div class="mb-3 date-area">
                                    <label for="" class="block mb-2 text-sm font-normal text-[#2B313B]">Date of Birth </label>                                    
                                        <div class="flex">
                                            <input type="text" id="b-date" 
                                            class="rounded rounded-lg bg-white border border-[#F5F8FF] text-[#2B313B] font-normal text-sm focus:ring-none focus:outline-none focus:border-[#3b82f6] block flex-1 min-w-0 w-full p-2.5"
                                            placeholder="">
                                        </div>
                                </div>
                                <div class="mb-3">
                                    <label for="" class="block mb-2 text-sm font-normal text-[#2B313B]">Marital Status
                                    </label>
                                    
                                    <div class="t-select no-label">
                                            <select id="gender" class="bg-white border border-[#F5F8FF] text-[#2B313B] font-semibold text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                                                <option class="p-3 bg-white border-b border border-[#cccccc] text-sm rounded-lg font-base" value="Petrol" selected="">Married</option>
                                                <option class="p-3 bg-white border-b border border-[#cccccc] text-sm rounded-lg font-base" value="Diesel">Single</option>
                                                <option class="p-3 bg-white border-b border border-[#cccccc] text-sm rounded-lg font-base" value="Diesel">Divorced</option>
                                            </select>
                                    </div>
                                </div>
                                    <button type="button" class="p-4 text-center outline-btn btn-translate-z bg-[#112954] text-white w-full text-base mt-4 font-bold rounded-md">Compare Now</button>
                        ...
                        <div class="grid grid-cols-5 gap-2">
                            <img src="<?php echo e(asset('/frontend/assets/img/internet/01.svg')); ?>" alt="icon">
                            <img src="<?php echo e(asset('/frontend/assets/img/internet/02.svg')); ?>" alt="icon">
                            <img src="<?php echo e(asset('/frontend/assets/img/internet/03.svg')); ?>" alt="icon">
                            <img src="<?php echo e(asset('/frontend/assets/img/internet/04.svg')); ?>" alt="icon">
                            <img src="<?php echo e(asset('/frontend/assets/img/internet/05.svg')); ?>" alt="icon">
                            <img src="<?php echo e(asset('/frontend/assets/img/internet/06.svg')); ?>" alt="icon">
                            <img src="<?php echo e(asset('/frontend/assets/img/internet/08.svg')); ?>" alt="icon">
                            <img src="<?php echo e(asset('/frontend/assets/img/internet/09.svg')); ?>" alt="icon">
                            <img src="<?php echo e(asset('/frontend/assets/img/internet/10.svg')); ?>" alt="icon">
                        </div>
                    </div>
    ...
    <section class="bg-white p-4 md:p-12 w-full items-center mx-auto">
        <div class="container mx-auto max-w-screen-xl">
            <h2 class="text-center font-semibold text-[32px] text-[#2B313B] leading-none mt-6 mb-14">How does it work?</h2>
                    ...
                    <div class="p-5 rounded-2xl border border-[#F5F8FF] bg-white">
                        <form action="" class="flex flex-col">
                            ...
                            <div class="mb-3">
                                ...
                                <button type="button" class="p-2.5 text-center outline-btn btn-translate-z bg-[#112954] text-white w-full text-base mt-4 font-bold rounded-md">Compare Now</button>
                            
                        </form>
                    </div>
                    
                    <p class="text-[#2B313B] text-base font-normal text-center mb-8 md:mb-0 mt-4 px-2">1. Enter postal code and select package type</p>
                </div>
                <div class="w-full lg:w-80 range-sec mb-4 md:mb-0">

                    <span class="single-filter mb-9 p-5 block rounded-2xl border border-[#F5F8FF] bg-white">
                    ...
                    <span class="single-filter p-5 block rounded-2xl border border-[#F5F8FF] bg-white">
                    ...
                    <p class="text-[#2B313B] text-base font-normal text-center mb-8 md:mb-0 mt-4 md:mt-[72px] px-2">2. Filter subscriptions according to your wishes</p>
                </div>
                <div class="w-full lg:w-80 mb-4 md:mb-0">
                <div class="grid grid-cols-1 gap-8 content-start">
                        <div class="bg-[#F5F8FF]  p-3 rounded-2xl">
                            <div class="flex items-center justify-between mb-2">
                                <span class="bg-[#9BAECF] rounded w-20 h-[27px]">
                    ...
                    <p class="text-[#2B313B] text-base font-normal text-center mb-8 md:mb-0 mt-4 md:mt-[88px] px-2">3. All subscriptions at a glance</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto max-w-screen-xl">
            ...
            <div class="flex flex-col lg:flex-row items-center justify-between pb-8">
                <div class="bg-white w-full mb-4 lg:mb-0 md:w-[308px] p-5 flex flex-col text-center border border-[#F5F8FF] rounded-2xl">
                    <img src="<?php echo e(asset('/frontend/assets/img/internet/001.svg')); ?>" class="pt-4 h-auto w-20 mx-auto mb-4" alt="icon">
                ...
                <div class="bg-white w-full mb-4 lg:mb-0 md:w-[308px] p-5 flex flex-col text-center border border-[#F5F8FF] rounded-2xl">
                    <img src="<?php echo e(asset('/frontend/assets/img/internet/002.svg')); ?>" class="pt-4 h-auto w-20 mx-auto mb-4" alt="icon">
                ...
                <div class="bg-white w-full mb-4 lg:mb-0 md:w-[308px] p-5 flex flex-col text-center border border-[#F5F8FF] rounded-2xl">
                    <img src="<?php echo e(asset('/frontend/assets/img/internet/003.svg')); ?>" class="pt-4 h-auto w-20 mx-auto mb-4" alt="icon">
            ...
            <div class="flex flex-col md:flex-row items-center justify-between py-6">
                <div class="w-full md:w-1/2 pr-4 mb-4 lg:mb-0">
                    ...
                    <span class="flex flex-row items-center">
                        <img src="<?php echo e(asset('/frontend/assets/img/internet/support-01.svg')); ?>" class="mr-4" alt="logo">
                        <img src="<?php echo e(asset('/frontend/assets/img/internet/support-02.svg')); ?>" alt="logo">
                    </span>
                </div>
...
} elseif ($_instance->childHasBeenRendered('l3464451513-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3464451513-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3464451513-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3464451513-0');
} else {
    $response = \Livewire\Livewire::mount('components.news-slider.news-slider', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3464451513-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    ...
    <script>        
        ...
        $('.center').slick({
          ...
          slidesToScroll: 1,
          arrows: true,
          prevArrow: '<button class="slick-next slick-arrow" aria-label="Next" type="button"><img src="<?php echo e(asset('/frontend/assets/img/slider/angle-right.svg')); ?>" class="h-8 w-8" alt="previous-arrow"></button>',
          nextArrow: '<button class="slick-prev slick-arrow" aria-label="Previous" type="button"><img src="<?php echo e(asset('/frontend/assets/img/slider/angle-left.svg')); ?>" class="h-8 w-8" alt="next-arrow"></button>',
          autoplay: true,
          autoplaySpeed: 3000,
          responsive: [
            {
...
<?php /**PATH /home/dh_ag462h/bereken.webonedevs.com/resources/views/livewire/borrow-money/borrow-money.blade.php ENDPATH**/ ?>