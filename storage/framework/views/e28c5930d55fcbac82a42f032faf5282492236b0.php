...
} elseif ($_instance->childHasBeenRendered('l1956308957-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1956308957-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1956308957-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1956308957-0');
} else {
    $response = \Livewire\Livewire::mount('components.vats.featured-calculators', []);
    $html = $response->html();
    $_instance->logRenderedChild('l1956308957-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>     
                    <?php
...
} elseif ($_instance->childHasBeenRendered('l1956308957-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l1956308957-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1956308957-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1956308957-1');
} else {
    $response = \Livewire\Livewire::mount('components.vats.related-news', []);
    $html = $response->html();
    $_instance->logRenderedChild('l1956308957-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php
...
} elseif ($_instance->childHasBeenRendered('l1956308957-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l1956308957-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1956308957-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1956308957-2');
} else {
    $response = \Livewire\Livewire::mount('components.vats.faq-section', []);
    $html = $response->html();
    $_instance->logRenderedChild('l1956308957-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l1956308957-3')) {
    $componentId = $_instance->getRenderedChildComponentId('l1956308957-3');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1956308957-3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1956308957-3');
} else {
    $response = \Livewire\Livewire::mount('components.vats.vat-ratings', []);
    $html = $response->html();
    $_instance->logRenderedChild('l1956308957-3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php /**PATH /home/dh_ag462h/bereken.webonedevs.com/resources/views/livewire/calculators/v-a-t/vat-result.blade.php ENDPATH**/ ?>