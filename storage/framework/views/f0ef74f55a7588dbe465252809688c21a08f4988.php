            ...
            <div class="services-area w-full py-8">
                ...
                <div class="flex-none md:flex md:items-center md:justify-around">
                    <div class="w-full md:w-80 flex flex-col">
                        <h1 class="flex items-center text-base font-normal text-[#26BA65] mb-5"><img src="<?php echo e(asset('/frontend/assets/img/verified.svg')); ?>" class="w-6 h-6 mr-2" alt="icon"> Number retention guarantee</h1>
                        ...
                        <div :class="{'block': open, 'hidden': !open}" class="hidden p-5 rounded-2xl border border-[#F5F8FF] bg-white">
                            <form action="<?php echo e(url('/sim-package')); ?>" method="post" class="flex flex-col">
                                <?php echo csrf_field(); ?>

                                
                                <div class="mb-3">
                                    <label for="" class="block mb-2 text-sm font-normal text-[#2B313B]">Current Provider</label>
                                    
                                    <div class="t-select no-label">
                                            <select id="gender" name="provider" class="bg-white border border-[#F5F8FF] text-[#2B313B] font-semibold text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                                                <option class="p-3 bg-white border-b border border-[#cccccc] text-sm rounded-lg font-base" value="50-mobiel" selected="">50+ Mobiel</option>
                                ...
                                <div class="mb-3">                      
                                    <div class="p-5 rounded-2xl border border-[#F5F8FF] bg-white">
                                        <span class="relative flex items-center justify-end">
                                            <label for="minutes3" class="absolute inset-y-0 left-0 font-normal text-sm text-[#2B313B]">Minutes</label> 
                                                <div class="order-3 flex items-center">
                                                </div>
                                        </span>
                                        <input class="w-full"  id="minutes3" name="min" type="range" min="0" max="120" value="50">
                                    </div>                                         
                                    <div class="p-5 rounded-2xl border border-[#F5F8FF] bg-white">
                                        <span class="relative flex items-center justify-end">
                                            <label for="monthly3" class="absolute inset-y-0 left-0 font-normal text-sm text-[#2B313B]">data</label>
                                            
                                                <div class="order-1 font-semibold text-sm text-[#0052FE]  mr-1"></div>
                                                
                                            </span>
                                        <input class="w-full" id="monthly3" name="data" type="range" min="0" max="500" value="50">
                                    </div>     
                                </div>
                                    <button type="submit" class="p-4 text-center outline-btn btn-translate-z bg-[#112954] text-white w-full text-base font-bold rounded-md">Compare Now</button>
                        ...
                        <div class="grid grid-cols-5 gap-2">
                            ...
                            <img src="<?php echo e(asset('/frontend/assets/img/internet/07.svg')); ?>" alt="icon">
                        ...
                        <div class="form-area p-5 rounded-2xl border border-[#F5F8FF] bg-white">
                            <form action="<?php echo e(url('/sim-package')); ?>" method="post" class="flex flex-col">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="t-select no-label">
                                        <select id="gender" name="provider" class="bg-white border border-[#F5F8FF] text-[#2B313B] font-semibold text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                                            <option class="p-3 bg-white border-b border border-[#cccccc] text-sm rounded-lg font-base" value="all" selected="">Alles</option>
                                ...
                                <div class="mb-3">                      
                                    <div class="bg-white">
                                        <span class="relative flex items-center justify-end">
                                            <label for="minutes" class="absolute inset-y-0 left-0 font-normal text-sm text-[#2B313B]">Minutes</label> 
                                                <div class="order-3 flex items-center">
                                                </div>
                                        </span>
                                        <input class="w-full"  id="minutes" name="min" type="range" min="0" max="100" step="10" value="50">
                                    </div>                                         
                                    <div class=" bg-white">
                                        <span class="relative flex items-center justify-end">
                                            <label for="monthly" class="absolute inset-y-0 left-0 font-normal text-sm text-[#2B313B]">Data</label>
                                            

                                                
                                            </span>
                                        <input class="w-full" id="monthly" name="data" type="range" min="0" step="" max="100" value="50">
                                    </div>     
                                </div>
                                    <button type="submit" class="p-4 text-center outline-btn btn-translate-z bg-[#112954] text-white w-full text-sm font-bold rounded-md">Compare Now</button>
                ...
                <div class="w-full lg:w-80 range-sec mb-4 md:mb-0">
                    <form class="grid grid-cols-1 gap-8">
                        <div class="p-[19px] rounded-2xl border border-[#F5F8FF] bg-white">
                            <span class="relative flex items-center justify-end">
                                <label for="data" class="absolute inset-y-0 left-0 font-normal text-sm text-[#2B313B]">Data</label>
                                    <div class="order-3 flex items-center">
                                        <!-- <div id="" class="counter-top font-semibold text-sm text-[#0052FE]"></div> -->

                                        <div class="font-semibold text-sm text-[#0052FE]">GB</div>
                                    </div>
                            </span>
                        ...
                        <div class="p-[19px] rounded-2xl border border-[#F5F8FF] bg-white">
                            <span class="relative flex items-center justify-end">
                                <label for="monthly2" class="absolute inset-y-0 left-0 font-normal text-sm text-[#2B313B]">Monthly</label>
                    ...
                    <p class="text-[#2B313B] text-base font-normal text-center mb-8 md:mb-0 mt-4 px-2">2. Filter subscriptions according to your wishes</p>
                </div>
                <div class="w-full lg:w-80 mb-4 md:mb-0">
                    ...
                    <p class="text-[#2B313B] text-base font-normal text-center mb-8 md:mb-0 mt-4 px-2">3. All subscriptions at a glance</p>
                </div>
            </div>
        </div>
    </section>
...
} elseif ($_instance->childHasBeenRendered('l2944002935-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2944002935-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2944002935-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2944002935-0');
} else {
    $response = \Livewire\Livewire::mount('components.news-slider.news-slider', []);
    $html = $response->html();
    $_instance->logRenderedChild('l2944002935-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/dh_ag462h/bereken.webonedevs.com/resources/views/livewire/sim-only/sim-only.blade.php ENDPATH**/ ?>